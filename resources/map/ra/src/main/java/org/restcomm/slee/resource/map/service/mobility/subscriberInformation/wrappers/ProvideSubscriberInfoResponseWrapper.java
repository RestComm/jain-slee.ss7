 ...
 * 
 */
public class ProvideSubscriberInfoResponseWrapper extends MobilityMessageWrapper<ProvideSubscriberInfoResponse> implements ProvideSubscriberInfoResponse {

    private static final String EVENT_TYPE_NAME = "ss7.map.service.mobility.subscriberinfo.PROVIDE_SUBSCRIBER_INFO_RESPONSE";

    public ProvideSubscriberInfoResponseWrapper(MAPDialogMobilityWrapper mAPDialog, ProvideSubscriberInfoResponse req) {
    ...
    public String toString() {
        return "ProvideSubscriberInfoResponseWrapper [wrapped=" + this.wrappedEvent + "]";
    }
