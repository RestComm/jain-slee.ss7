...
public class MAPDialogSmsWrapper extends MAPDialogWrapper<MAPDialogSms> implements MAPDialogSms {
	...
	public Long addInformServiceCentreRequest(ISDNAddressString arg0, MWStatus arg1, MAPExtensionContainer arg2,
		...
		return this.getWrappedDialog().addInformServiceCentreRequest(arg0, arg1, arg2, arg3, arg4);
	}
	...
	public Long addInformServiceCentreRequest(int arg0, ISDNAddressString arg1, MWStatus arg2,
		...
		return this.getWrappedDialog().addInformServiceCentreRequest(arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public Long addMoForwardShortMessageRequest(SM_RP_DA arg0, SM_RP_OA arg1, SmsSignalInfo arg2,
		...
		return this.getWrappedDialog().addMoForwardShortMessageRequest(arg0, arg1, arg2, arg3, arg4);
	}
	...
	public Long addMoForwardShortMessageRequest(int arg0, SM_RP_DA arg1, SM_RP_OA arg2, SmsSignalInfo arg3,
		...
		return this.getWrappedDialog().addMoForwardShortMessageRequest(arg0, arg1, arg2, arg3, arg4, arg5);
	}

	public void addMoForwardShortMessageResponse(long arg0, SmsSignalInfo arg1, MAPExtensionContainer arg2)
			throws MAPException {
		this.getWrappedDialog().addMoForwardShortMessageResponse(arg0, arg1, arg2);
	}
	...
	public Long addMtForwardShortMessageRequest(SM_RP_DA arg0, SM_RP_OA arg1, SmsSignalInfo arg2, boolean arg3,
		...
		return this.getWrappedDialog().addMtForwardShortMessageRequest(arg0, arg1, arg2, arg3, arg4);
	}
	...
	public Long addMtForwardShortMessageRequest(int arg0, SM_RP_DA arg1, SM_RP_OA arg2, SmsSignalInfo arg3,
		...
		return this.getWrappedDialog().addMtForwardShortMessageRequest(arg0, arg1, arg2, arg3, arg4, arg5);
	}

	public void addMtForwardShortMessageResponse(long arg0, SmsSignalInfo arg1, MAPExtensionContainer arg2)
			throws MAPException {
		this.getWrappedDialog().addMtForwardShortMessageResponse(arg0, arg1, arg2);
	}
	...
	public Long addReportSMDeliveryStatusRequest(int arg0, ISDNAddressString arg1, AddressString arg2,
		...
		return this.getWrappedDialog().addReportSMDeliveryStatusRequest(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7,
				arg8, arg9);
	}

	public void addReportSMDeliveryStatusResponse(long arg0, ISDNAddressString arg1, MAPExtensionContainer arg2)
			throws MAPException {
		this.getWrappedDialog().addReportSMDeliveryStatusResponse(arg0, arg1, arg2);
	}
	...
	public Long addSendRoutingInfoForSMRequest(ISDNAddressString msisdn, boolean sm_RP_PRI, AddressString serviceCentreAddress,
			...
			throws MAPException {
		return this.getWrappedDialog().addSendRoutingInfoForSMRequest(msisdn, sm_RP_PRI, serviceCentreAddress, extensionContainer, gprsSupportIndicator, sM_RP_MTI,
	...
	public Long addSendRoutingInfoForSMRequest(int customInvokeTimeout, ISDNAddressString msisdn, boolean sm_RP_PRI, AddressString serviceCentreAddress,
			MAPExtensionContainer extensionContainer, boolean gprsSupportIndicator, SM_RP_MTI sM_RP_MTI, SM_RP_SMEA sM_RP_SMEA, TeleserviceCode teleservice)
			throws MAPException {
		return this.getWrappedDialog().addSendRoutingInfoForSMRequest(customInvokeTimeout, msisdn, sm_RP_PRI, serviceCentreAddress, extensionContainer,
	...
	public void addSendRoutingInfoForSMResponse(long invokeId, IMSI imsi, LocationInfoWithLMSI locationInfoWithLMSI, MAPExtensionContainer extensionContainer,
		...
		this.getWrappedDialog().addSendRoutingInfoForSMResponse(invokeId, imsi, locationInfoWithLMSI, extensionContainer, mwdSet);
	}
    ...
    public Long addReadyForSMRequest(IMSI imsi, AlertReason alertReason, boolean alertReasonIndicator, MAPExtensionContainer extensionContainer,
        ...
        return this.getWrappedDialog().addReadyForSMRequest(imsi, alertReason, alertReasonIndicator, extensionContainer, additionalAlertReasonIndicator);
    }
    ...
    public Long addReadyForSMRequest(int customInvokeTimeout, IMSI imsi, AlertReason alertReason, boolean alertReasonIndicator,
        ...
        return this.getWrappedDialog().addReadyForSMRequest(customInvokeTimeout, imsi, alertReason, alertReasonIndicator, extensionContainer,
    ...
    public void addReadyForSMResponse(long invokeId, MAPExtensionContainer extensionContainer) throws MAPException {
        this.getWrappedDialog().addReadyForSMResponse(invokeId, extensionContainer);
    }

    @Override
    public Long addNoteSubscriberPresentRequest(IMSI imsi) throws MAPException {
        return this.getWrappedDialog().addNoteSubscriberPresentRequest(imsi);
    }

    @Override
    public Long addNoteSubscriberPresentRequest(int customInvokeTimeout, IMSI imsi) throws MAPException {
        return this.getWrappedDialog().addNoteSubscriberPresentRequest(customInvokeTimeout, imsi);
    }
