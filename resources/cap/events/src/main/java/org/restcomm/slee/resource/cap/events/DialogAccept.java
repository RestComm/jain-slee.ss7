...
public class DialogAccept extends CAPEvent {
	 ...
	 */
	public DialogAccept(CAPDialog capDialogWrapper, CAPGprsReferenceNumber capGprsReferenceNumber) {
	...
	public String toString() {
		return "DialogAccept [capGprsReferenceNumber=" + capGprsReferenceNumber + ", capDialogWrapper=" + capDialogWrapper
				+ "]";
	}
}
