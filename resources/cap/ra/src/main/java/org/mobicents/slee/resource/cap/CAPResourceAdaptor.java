 ...
 *
 */
public class CAPResourceAdaptor implements ResourceAdaptor, FaultTolerantResourceAdaptor<Long,byte[]>, CAPDialogListener, CAPServiceCircuitSwitchedCallListener,
    ...
    private final CapMarshaler marshaler;
    ...
    public void activityEnded(ActivityHandle activityHandle) {
        ...
        final CAPDialogWrapper dw = (CAPDialogWrapper)getActivity(mdah);
    ...
    public void eventProcessingFailed(ActivityHandle handle, FireableEventType eventType, Object event,
        ...
        if (eventType.getEventType().getName().equals(DialogTimeout.EVENT_TYPE_NAME)) {
            ...
            CAPDialogWrapper dw = (CAPDialogWrapper)getActivity(handle);
            if (dw != null)
                releaseDialog(dw);
        }
    }
    ...
    public void eventProcessingSuccessful(ActivityHandle handle, FireableEventType eventType, Object event,
        ...
        if (eventType.getEventType().getName().equals(DialogTimeout.EVENT_TYPE_NAME)) {
            CAPDialogActivityHandle dah = (CAPDialogActivityHandle) handle;
            CAPDialogWrapper dw = (CAPDialogWrapper)getActivity(dah);
    ...
    public Object getActivity(ActivityHandle handle) {
        if(! (handle instanceof CAPDialogActivityHandle))
            return null;

        CAPDialogActivityHandle cah=(CAPDialogActivityHandle)handle;
        if(cah.hasCachedActivity())
            return cah.getActivity();
        CAPDialogWrapper activity=retrieveCapDialogWrapper(cah.getDialogId());
        cah.setActivity(activity);
        cah.setRa(this);
        return activity;
    }
    ...
    public void queryLiveness(ActivityHandle activityHandle) {
        ...
        final CAPDialogWrapper capDialog = (CAPDialogWrapper)getActivity(handle);
    ...
    public void startActivity(CAPDialogWrapper capDialogWrapper) throws ActivityAlreadyExistsException,
        ...
        this.sleeEndpoint.startActivity(capDialogWrapper.getActivityHandle(), capDialogWrapper, MARSHALABLE_ACTIVITY_FLAGS |
    ...
    public void onDialogAccept(CAPDialog capDialog, CAPGprsReferenceNumber capGprsReferenceNumber) {
        CAPDialogWrapper capDialogWrapper = retrieveCapDialogWrapper(capDialog.getLocalDialogId());
    ...
    private void handleDialogRequest(CAPDialog capDialog, CAPGprsReferenceNumber capGprsReferenceNumber) {
        try {
            ...
            CAPDialogActivityHandle activityHandle = new CAPDialogActivityHandle(this,capDialog.getLocalDialogId());
            ...
            storeCapDialogWrapper(capDialogWrapper);
    ...
    public void onDialogTimeout(CAPDialog capDialog) {
        ...
        boolean fired = false;
        try {
            fired = fireEvent(dt.getEventTypeName(), capDialogWrapper.getActivityHandle(), dt,
    ...
    public void onInitialDPRequest(InitialDPRequest ind) {
        CAPDialogCircuitSwitchedCallWrapper capDialogCircuitSwitchedCallWrapper = (CAPDialogCircuitSwitchedCallWrapper) retrieveCapDialogWrapper(ind.getCAPDialog().getLocalDialogId());
    ...
    public void onInitialDpGprsRequest(InitialDpGprsRequest ind) {
        CAPDialogGprsWrapper capDialogGprsWrapper = (CAPDialogGprsWrapper) retrieveCapDialogWrapper(ind.getCAPDialog().getLocalDialogId());
    ...
    public void onConnectSMSRequest(ConnectSMSRequest ind) {
        CAPDialogSmsWrapper capDialogSmsWrapper = (CAPDialogSmsWrapper) retrieveCapDialogWrapper(ind.getCAPDialog().getLocalDialogId());
    ...
    public void failOver(Long key) {
        if(tracer.isTraceable(TraceLevel.INFO))
            tracer.info("Cache reports CAPDialogWrapper failOver "+key);
    }
    ...
    private CAPDialogWrapper retrieveCapDialogWrapper(Long dialogId) {
        ...
        if(b!=null) {
            try {
                ...
                wrapper=(CAPDialogWrapper)bis.readObject();
            } catch(Exception e) {
    ...
    public <T extends CAPDialog> T getWrappedDialog(Long dialogId) {
        CAPDialog cdia=this.realProvider.getCAPDialog(dialogId);
        return (T)cdia;
    }
}
