 ...
 * 
 */
public class CancelGPRSRequestWrapper extends GprsMessageWrapper<CancelGPRSRequest>
implements CancelGPRSRequest{
	
	private static final String EVENT_TYPE_NAME = "ss7.cap.service.gprs.CANCEL_GPRS_REQUEST";
	
	public CancelGPRSRequestWrapper(CAPDialogGprsWrapper capDialog, CancelGPRSRequest req) {
