 ...
 * 
 */
public class ApplyChargingReportGPRSRequestWrapper  extends GprsMessageWrapper<ApplyChargingReportGPRSRequest> 
 implements ApplyChargingReportGPRSRequest {
	...
	public ApplyChargingReportGPRSRequestWrapper(CAPDialogGprsWrapper capDialog, 
			ApplyChargingReportGPRSRequest req) {
		super(capDialog, EVENT_TYPE_NAME, req);
	}
	
	@Override
	public boolean getActive() {
		return this.wrappedEvent.getActive();
	}

	@Override
	public ChargingResult getChargingResult() {
		return this.wrappedEvent.getChargingResult();
	}

	@Override
	public ChargingRollOver getChargingRollOver() {
		return this.wrappedEvent.getChargingRollOver();
	}
