 ...
 * 
 */
public class PromptAndCollectUserInformationResponseWrapper extends CircuitSwitchedCallMessageWrapper<PromptAndCollectUserInformationResponse> implements
	...
	public PromptAndCollectUserInformationResponseWrapper(CAPDialogCircuitSwitchedCallWrapper capDialog, PromptAndCollectUserInformationResponse req) {
		super(capDialog, EVENT_TYPE_NAME, req);
	}

	@Override
	public Digits getDigitsResponse() {
		return this.wrappedEvent.getDigitsResponse();
	}
