...
public class CancelRequestWrapper extends CircuitSwitchedCallMessageWrapper<CancelRequest> implements CancelRequest {
	...
	public CancelRequestWrapper(CAPDialogCircuitSwitchedCallWrapper capDialog, CancelRequest req) {
		super(capDialog, EVENT_TYPE_NAME, req);
	}

	public boolean getAllRequests() {
		return this.wrappedEvent.getAllRequests();
	}

	public CallSegmentToCancel getCallSegmentToCancel() {
		return this.wrappedEvent.getCallSegmentToCancel();
	}
