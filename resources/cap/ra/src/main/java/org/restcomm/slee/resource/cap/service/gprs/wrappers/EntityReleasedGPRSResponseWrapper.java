 ...
 * 
 */
public class EntityReleasedGPRSResponseWrapper extends GprsMessageWrapper<EntityReleasedGPRSResponse> 
implements EntityReleasedGPRSResponse {
	
	private static final String EVENT_TYPE_NAME = "ss7.cap.service.gprs.ENTITY_RELEASED_GPRS_RESPONSE";
	
	public EntityReleasedGPRSResponseWrapper(CAPDialogGprsWrapper capDialog, EntityReleasedGPRSResponse req) {
