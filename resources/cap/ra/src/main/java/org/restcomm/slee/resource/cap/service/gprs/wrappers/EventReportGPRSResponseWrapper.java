 ...
 * 
 */
public class EventReportGPRSResponseWrapper extends GprsMessageWrapper<EventReportGPRSResponse> 
implements  EventReportGPRSResponse{
	
	private static final String EVENT_TYPE_NAME = "ss7.cap.service.gprs.EVENT_REPORT_GPRS_RESPONSE";
	
	public EventReportGPRSResponseWrapper(CAPDialogGprsWrapper capDialog, EventReportGPRSResponse req) {
