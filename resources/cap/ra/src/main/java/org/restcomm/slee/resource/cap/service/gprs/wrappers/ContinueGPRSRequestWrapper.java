 ...
 * 
 */
public class ContinueGPRSRequestWrapper extends GprsMessageWrapper<ContinueGPRSRequest> 
implements ContinueGPRSRequest{
	
	private static final String EVENT_TYPE_NAME = "ss7.cap.service.gprs.CONTINUE_GPRS_REQUEST";
	
	public ContinueGPRSRequestWrapper(CAPDialogGprsWrapper capDialog, ContinueGPRSRequest req) {
